...
class TestISODateEncoder:
    ...
    def test_encode_datetime(self, app_context):
    ...
    def test_encode_date(self, app_context):
...
class TestReadPositionYaml:
    ...
    def test_valid_position_yaml(self, app_context):
    ...
    def test_invalid_yaml_format(self, app_context):
    ...
    def test_validation_error_yaml(self, app_context):
...
class TestReadTradeCsv:
    ...
    def test_valid_cpty_a_csv(self, app_context):
    ...
    def test_valid_cpty_b_csv(self, app_context):
    ...
    def test_invalid_csv_format(self, app_context):
        """Test reading invalid CSV format."""
        file = Mock()
        file.stream.read.return_value = b'not valid csv'
        
        result = read_trade_csv(file, 'CptyA')
        assert result.status in ['data validation errors', 'input error']
...
class TestReportPosition:
    ...
    def test_report_position_empty(self, app_context):
        """Test reporting positions from empty query."""
        query = Positions.query.all()
        result = report_position(query)
        assert len(result) == 0
    
    def test_report_position_with_data(self, db_with_positions):
...
class TestReportConcentration:
    ...
    def test_report_concentration_no_breaches(self, app_context):
    ...
    def test_report_concentration_with_breach(self, app_context):
...
class TestReportReconciliation:
    ...
    def test_report_reconciliation_matching(self, app_context):
    ...
    def test_report_reconciliation_mismatch(self, app_context):
